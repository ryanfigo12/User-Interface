...
<div class="h-screen pb-14 bg-right bg-cover" style="background-image:url('asssets/gambar\ 1.jpg');">
	<!--Nav-->
	<div class="w-full container mx-auto p-6">
			
		<div class="w-full flex items-center justify-between">
			<a class="flex items-center text-indigo-50 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"  href="index.php"> 
				 Beranda
			</a>
			
			<div class="flex w-1/2 justify-end content-center">		
				<a class="inline-block text-indigo-50 no-underline hover:text-indigo-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4" data-tippy-content="@twitter_handle" href="?mod=rekap">
					Menu
				</a>
				<a class="inline-block text-indigo-50 no-underline hover:text-indigo-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 " data-tippy-content="#facebook_id" href="?mod=book">
					Produk
				</a>
			</div>
